...
namespace PhotoManager.Utility
{
    /// <summary>
    /// 创 建 者:小莫
    /// 创建日期:2018-08-06 20:55:59
    /// 描   述:功能描述
	///
    /// </summary>
    public class PictureEXIF : IEnumerable
    {
        ...
        /// <param name="sp"></param>  
        public PictureEXIF(ref System.Drawing.Bitmap bmp, string sp)
        {
        ...
        string msp = "";
        public PictureEXIF(ref System.Drawing.Bitmap bmp, string sp, string msp)
        {
            properties = new Hashtable();
            this.sp = sp;
            this.msp = msp;
        ...
        public PictureEXIF(string file, string sp, string msp)
        {
            properties = new Hashtable();
            this.sp = sp;
            this.msp = msp;
        ...
        private void buildDB(System.Drawing.Imaging.PropertyItem[] parr)
        {
            ...
            data = "";
            //  
            Encoding ascii = System.Text.UnicodeEncoding.UTF8;
            //  
